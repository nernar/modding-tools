function LegacySidebarFragment() {
...
LegacySidebarFragment.prototype = new BaseFragment;

LegacySidebarFragment.prototype.resetContainer = function() {
...
LegacySidebarFragment.prototype.getItemContainer = function() {
	return this.findViewByTag("containerItems");
};

LegacySidebarFragment.prototype.addItem = function(view, index) {
...
LegacySidebarFragment.prototype.clearItems = function() {
	let items = this.getItemContainer();
	if (items == null) return this;
...
LegacySidebarFragment.prototype.removeItem = function(view) {
	let items = this.getItemContainer();
	if (items == null) return this;
...
LegacySidebarFragment.prototype.getItemAt = function(index) {
	let items = this.getItemContainer();
	if (items == null) return null;
	return items.getChildAt(index);
};

LegacySidebarFragment.prototype.indexOfItem = function(view) {
	let items = this.getItemContainer();
	if (items == null) return -1;
	return items.indexOfChild(view);
};

LegacySidebarFragment.prototype.getItemCount = function() {
	let items = this.getItemContainer();
	if (items == null) return -1;
	return items.getChildCount();
};

LegacySidebarFragment.prototype.getTabContainer = function() {
	return this.findViewByTag("containerTabs");
};

LegacySidebarFragment.prototype.getTabBackground = function() {
	return this.tabBackground || null;
};

LegacySidebarFragment.prototype.setTabBackground = function(src) {
	if (isAndroid()) {
...
LegacySidebarFragment.prototype.addTab = function(view, index) {
...
LegacySidebarFragment.prototype.clearTabs = function() {
	let tabs = this.getTabContainer();
	if (tabs == null) return this;
	tabs.removeAllViews();
	return this;
...
LegacySidebarFragment.prototype.removeTab = function(view) {
	let tabs = this.getTabContainer();
	if (tabs == null) return this;
...
LegacySidebarFragment.prototype.getTabAt = function(index) {
	let tabs = this.getTabContainer();
	if (tabs == null) return null;
	return tabs.getChildAt(index);
};

LegacySidebarFragment.prototype.indexOfTab = function(view) {
	let tabs = this.getTabContainer();
	if (tabs == null) return -1;
	return tabs.indexOfChild(view);
};

LegacySidebarFragment.prototype.getTabCount = function() {
	let tabs = this.getTabContainer();
	if (tabs == null) return -1;
	return tabs.getChildCount();
};

LegacySidebarFragment.Group = new Function();

LegacySidebarFragment.Group = function() {
...
LegacySidebarFragment.Group.prototype = new ImageFragment;

LegacySidebarFragment.Group.prototype.resetContainer = function() {
	let container = new android.widget.LinearLayout(getContext());
...
LegacySidebarFragment.Group.prototype.getImageView = function() {
	return this.findViewByTag("groupImage");
};

LegacySidebarFragment.Group.prototype.setImage = function(src) {
...
LegacySidebarFragment.Group.Item = function() {
	ImageFragment.apply(this, arguments);
	if (isAndroid()) {
		this.resetContainer();
	}
...
LegacySidebarFragment.Group.Item.prototype = new ImageFragment;

LegacySidebarFragment.Group.Item.prototype.resetContainer = function() {
...
LegacySidebarFragment.Group.Item.prototype.getImageView = function() {
	return this.getContainer();
};

LegacySidebarFragment.Group.Item.prototype.setImage = function(src) {
	let container = this.getContainer();
	if (container == null) return this;
	if (src !== null && typeof src == "object") {
...
LegacySidebarFragment.Group.Item.prototype.getTitle = function() {
	return this.title || null;
};

LegacySidebarFragment.Group.Item.prototype.setTitle = function(title) {
	let container = this.getContainer();
	if (container == null) return this;
	// TODO
	this.title = title;
