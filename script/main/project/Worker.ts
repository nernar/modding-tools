class Worker {
	...
	appendProperty(source: object, properties: string[], difference: number) {
	...
	setProperty(source: object, properties: string[], value: any) {
		if (arguments.length < 3) {
	...
	resetProperty(source: object, properties: string[]) {
		if (arguments.length < 2) {
